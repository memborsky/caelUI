...
if caelUI.config.player.class ~= "ROGUE" then return end
...
-----------
-- Recuperate
Create(GetSpellName(73651), "player", "buff", true, 0.31, 0.45, 0.63, 158, 10, "BOTTOM", UIParent, "BOTTOM", 0, 331)

-- Slice and Dice
Create(GetSpellName(5171), "player", "buff", true, 0.31, 0.45, 0.63, 158, 10, "BOTTOM", UIParent, "BOTTOM", 0, 316)

-------------
-- Debuffs --
-------------
-- Expose Amor
Create(GetSpellName(8647), "target", "debuff", false, 0.31, 0.45, 0.63, 158, 10, "BOTTOM", UIParent, "BOTTOM", 0, 256)
